...
@section('content')
<div class="container">
    <h1>Edit Goods Issue #{{ $goodsIssue->number }}</h1>
    ...
    <form action="{{ route('goods_issues.update', $goodsIssue->id) }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input disabled type="date" name="document_date" class="form-control" value="{{ old('document_date', $goodsIssue->document_date) }}" required>
        </div>
